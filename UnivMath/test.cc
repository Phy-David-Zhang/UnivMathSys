...
void Test_SmartUMS_SmartSet_SmartSet()
{
	...
	Set *TestSet = new Set;
	TestSet->GetSmartElement()->LetSymbol("g");
	TestSet->GetSmartProperty()->LetSymbol("g\\in G");
	SmartSet TestSmartSetD(*TestSet);
	SmartSet TestSmartSetE;
	TestSmartSetE = *TestSet;
	cout<<"    "<<TestSmartSetD.Formulation().GetSymbol()<<"  "
		<<TestSmartSetD.Formulation().GetTruthValue()<<endl;
	cout<<"    "<<TestSmartSetE.Formulation().GetSymbol()<<"  "
		<<TestSmartSetE.Formulation().GetTruthValue()<<endl;
	delete TestSmartSetA; delete TestSet;
	cout<<endl;
}

bool TempCondition(IndepVar *Input)
	{return true;}

void Test_SmartUMS_Dynamic_DynamicPredicate()
{
	cout<<"------------------------------"<<endl;
	cout<<"Test of DynamicPredicate"<<endl;
	cout<<"  Original Settings"<<endl<<"    ";
	DynamicPredicate *TestPredicate = new DynamicPredicate;
	IndepVar *TempVar = new IndepVar;
	cout<<TestPredicate->Condition(TempVar)<<endl;
	cout<<endl<<"  Modified Settings"<<endl<<"    ";
	TestPredicate->LetDynamic(&TempCondition);
	cout<<TestPredicate->Condition(TempVar)<<endl;
	cout<<endl;
	delete TestPredicate; delete TempVar;
}
...
int main(void)
{
	...
	// test from smartums/dynamic
	Test_SmartUMS_Dynamic_DynamicPredicate();
	cout<<"------------------------------";
